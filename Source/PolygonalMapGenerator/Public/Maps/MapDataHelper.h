...
public:
	...
	UFUNCTION(BlueprintPure, Category = "World Generation|Island Generation|Map Data|Tags")
	...
	UFUNCTION(BlueprintCallable, Category = "World Generation|Island Generation|Map Data|Tags")
