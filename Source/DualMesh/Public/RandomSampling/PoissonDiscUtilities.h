...
public:
	...
	* @return Samples - Returned TArray of FVector2D containing the sample positions.
	*/
	...
	static TArray<FVector2D> Distribute2D(int32 Seed = 0, FVector2D Size = FVector2D(1.0, 1.0), float MinimumDistance = 1.0f, int32 MaxStepSamples = 30, bool WrapX = false, bool WrapY = false);
	...
	* @return Samples - Returned TArray of FVector containing the sample positions.
	*/
	...
	static TArray<FVector> Distribute3D(int32 Seed = 0, FVector Size = FVector(1.0, 1.0, 1.0), float MinimumDistance = 1.0f, int32 MaxStepSamples = 30, bool WrapX = false, bool WrapY = false, bool WrapZ = false);
};
